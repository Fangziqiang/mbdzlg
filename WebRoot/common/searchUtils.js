...
function openSeachWindowCustomSize(forward, conditions, searchfields, targetfields, consistfields, multiselect,selected,width,height) {
	...
	if(win_search == null){
		win_search = showwin("查询", url, width, height);
	}else{
		win_search.close();
		win_search = showwin("查询", url, width, height);
	}
...
function openSeachMoreWindow(forward, conditions,innerconditions, searchfields, targetfields, consistfields, multiselect,selected) {
	...
	if(win_search == null){
		win_search = showwin("查询", url, 600, 428);
	}else{
		win_search.close();
		win_search = showwin("查询", url, 600, 428);
	} 
