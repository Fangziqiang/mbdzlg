    ...
    function PE (pIds) {
		...
		document.write("			<input type=button Class='Button_Silver' value='打&nbsp;印' onclick='printCurrentPage(\"" + pIds + "\")'>");
		document.write("			<input type=button Class='Button_Silver' value='导&nbsp;出' onclick='savelist()'>");
		document.write("		</td>");
		document.write("	</tr>");
    ...
    function PEadd (pIds) {
		...
		document.write("	<tr align='center'>");
		document.write("		<td nowrap>");
		document.write("			<input type=button Class='Button_Silver' value='添&nbsp;加' onclick='add()'>");
		document.write("			<input type=button Class='Button_Silver' value='打&nbsp;印' onclick='printCurrentPage(\"" + pIds + "\")'>");
		document.write("			<input type=button Class='Button_Silver' value='导&nbsp;出' onclick='savelist()'>");
		document.write("		</td>");
		document.write("	</tr>");
    ...
    function PE_exportCloseButton (pIds) {
		...
		document.write("			<input type=button Class='Button_Silver' value='打&nbsp;印' onclick='printCurrentPage(\"" + pIds + "\")'>");
		document.write("			<input type=button Class='Button_Silver' value='导&nbsp;出' onclick='savelist()'>");
		document.write("			<input type=button Class='Button_Silver' value='关&nbsp;闭' onclick='closeWin()'>");
		document.write("		</td>");
		document.write("	</tr>");
		document.write("</table>");
	}
