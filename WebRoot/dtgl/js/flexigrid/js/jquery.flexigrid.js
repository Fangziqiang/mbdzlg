    ...
    $.addFlex = function(t, p) {
        ...
        if (p.colModel) {
            ...
            if (p.showcheckbox) {
                ...
                cth.addClass("cth").attr({ 'axis': "col-2", width: "22", "isch": true }).append(cthch);
                $(tr).append(cth);
            }
            ...
            if (p.rownum) {
                ...
                rth.addClass("rth").attr({ 'axis': "col-1", width: p.rownumWidth, align:'center',"isch": true });
                $(tr).append(rth);
            }
