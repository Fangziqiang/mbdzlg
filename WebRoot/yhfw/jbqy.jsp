					...
					<td colspan="2">
						<table  class="mb-table" style="border-bottom:1px solid #96b5d2;" width="95%" border="0" cellspacing="0" cellpadding="0" id="datatable">
							<tr  class="mb-ta-head" align='center' style="border-top: 1px">
								<th class="borderline" >禁爆区域经度</th>
								<th class="borderline" >禁爆区域纬度</th>
								<th class="borderline" >禁爆区域半径</th>
								<th class="borderline" >禁爆起始时间</th>
								<th class="borderline" >禁爆截止时间</th>
							</tr>
							<c:forEach items="${jbqyList}" var="jbqy">
								<tr>
									<td>
										${jbqy.jbqyjd }
									</td>
