...
public class TripleDES_GZM {
	...
	protected static String generateKey(){
		...
		*/
		return "jadlsoftjadlsoftjadlsoft";
	}
	...
	public static final byte[] encode(String waitforencode) {
		...
		try {				
			...
			byte[] waitforencode_bytes = waitforencode.getBytes("GBK");
...
public static final byte[] encode(String pre, String crc, String use) {		
	 ...
	 * @return 解密过后的字符串
	 */
	public static final String decode(byte[] waitfordecode) throws Exception {
...
//			String base = Base64.encode(encode(str));
//			System.out.println("Base64 = "+base + "       len = "+base.length());
//			System.out.println("de_Base64 = "+decode(Base64.decode(base)));
//			System.out.println("de_Base64.len = "+decode(Base64.decode(base)).length());
//			System.out.println("1F06023E4942D634628714060280E2CE83BCDE4499060280E2CE83BCDE4499".length());
//			System.out.println(decode("1F06023E4942D634628714060280E2CE83BCDE4499060280E2CE83BCDE4499".getBytes()));
			byte [] b = new byte[]{45, 104, 75, 3, -85, 108, -2, -67, 2, 2, 2, 2, 2, 2, 2, 2};
