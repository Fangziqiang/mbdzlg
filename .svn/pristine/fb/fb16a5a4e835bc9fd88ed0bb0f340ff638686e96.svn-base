package com.jadlsoft.utils.zip;
...
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable {
	...
	/**
	 * Platform specification to put into the &quot;version made by&quot; part
	 * of the central file header.
	 * 
	...
	public void addExtraField(ZipExtraField ze) {
		...
		boolean done = false;
		for (int i = 0, fieldsSize = extraFields.size(); !done
				&& i < fieldsSize; i++) {
			if (((ZipExtraField) extraFields.elementAt(i)).getHeaderId()
					.equals(type)) {
	...
	protected void setExtra() {
		super
				.setExtra(ExtraFieldUtils
						.mergeLocalFileDataData(getExtraFields()));
	}
