 ...
 * CRC and uncompressed size information is required before {@link #putNextEntry
 * putNextEntry} can be called.
 * </p>
 * 
 */
public class ZipOutputStream extends FilterOutputStream {
	 ...
	 * compatibility. This class used to extend {@link
	 * java.util.zip.DeflaterOutputStream DeflaterOutputStream} up to Revision
	 * 1.13.
	 * </p>
	 * 
	 * @since 1.14
